  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 w-4/5 mx-auto gap-2.5">
        {mockData.map((c) => (
          <div
            className="m-2 flex flex-col items-center rounded-4xl p-4 gap-1.5 shadow-lg border border-gray-300 max-w-[500px]"
            key={c.address}
          >
            ...
            <button
              className="bg-green-dark text-white px-4 py-2 mt-2 rounded-2xl w-1/2 cursor-pointer"
